...
from DonkeyCarEnv.config_ae import ENTER_KEY, EXIT_KEYS, LEFT_KEY, RIGHT_KEY

parser = argparse.ArgumentParser(description="Split a video into a sequence of images")
parser.add_argument(
    "-i", "--input_video", help="Input Video", default="", type=str, required=True
)
parser.add_argument(
    "-o", "--output_folder", help="Output folder", default="", type=str, required=True
)
parser.add_argument(
    "--display", action="store_true", default=False, help="Display the images"
)
