...
VAE_ARCHIVE_DIR = os.environ.get("VAE_ARCHIVE_DIR", "DonkeyCarEnv/vae-level-0-dim-32.pkl") # Pretrained VAE for level 0
...
def make_donkey_vae_env(device: torch.device, vae_path: str = None):
    if vae_path is None:
        vae_path = os.environ.get("VAE_ARCHIVE_DIR", "DonkeyCarEnv/vae-level-0-dim-32.pkl")
